...
final class InterproceduralLoopJoinRuleTest extends TestCase
{
    ...
    public function testFollowsACallReturnedDirectlyFromAMethod(): void
    {
        $index = $this->buildIndex([
            '/virtual/UserService.php' => <<<'PHP'
                <?php
                ...
                class UserService {
                    ...
                    private function matchAgainstOrders($user): void {
                        return $this->matcher->matchAll($user);
                    }
                }
                PHP,
            '/virtual/OrderMatcher.php' => <<<'PHP'
    ...
    public function testSuppressesWhenTheInnerLoopUnconditionallyReturnsAfterOnePass(): void
    {
        $index = $this->buildIndex([
            '/virtual/UserService.php' => <<<'PHP'
                <?php
    ...
    public function testConditionalBreakInTheInnerLoopStillReportsFinding(): void
    {
        $index = $this->buildIndex([
            '/virtual/UserService.php' => <<<'PHP'
                <?php
